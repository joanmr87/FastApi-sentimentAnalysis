...
def sentiment_analysis(sentiment_request: SentimentRequest):
    ...
    email_message = fetch_emails(sentiment_request.email, sentiment_request.fromTimestamp, sentiment_request.toTimestamp)
    sentences = format_email_contents(email_message)
